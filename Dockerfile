...
ARG LIBVA_VERSION=2.17.0
ARG INTEL_VAAPI_DRIVER_VERSION=2.4.1
ARG GMMLIB_VERSION=22.3.3
ARG INTEL_MEDIA_DRIVER_VERSION=22.6.6
ARG INTEL_MEDIA_SDK_VERSION=22.5.4
ARG INTEL_ONEVPL_GPU_RUNTIME_VERSION=22.6.5
...
# Pull base image.
FROM jlesage/baseimage-gui:alpine-3.17-v4.3.2
